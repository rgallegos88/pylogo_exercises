    ...
    def best_random_route(self):
        if self.middle_active:
            if self.top == 0 or self.bottom == 0 or self.middle == 0:
                ...
                if randint(1,100) < 100 - int(SimEngine.gui_get(RANDOMNESS)):
...
gui_left_upper = [[sg.Text('Middle On?', pad=((0,5), (20,0))), sg.CB('True', key=MIDDLE_ON, pad=((0,5), (10,0)))],
                  ...
                  [sg.Text('mode', pad=((0, 5), (20, 0))),
                   sg.Combo([BEST_RANDOM, EMPIRICAL_ANALYTICAl, PROBABILISTIC_GREEDY], key=SELECTION_ALGORITHM,
                            default_value=BEST_RANDOM, tooltip='Selection Algorithm', pad=((0, 5), (20, 0)))],
